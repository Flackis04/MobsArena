...
class BattlepassGui : Listener {
    ...
    private fun createPageInfoItem(page: Int): ItemStack =
        ItemStack(Material.BOOK).apply {
            editMeta { meta ->
                meta.displayName(nonItalicComponent("&bBattlepass Pages"))
                meta.lore(
                    listOf(
    ...
    private fun getRewardForTier(level: Int, track: RewardTrack): BattlepassReward {
        fun coinReward(amount: Long): BattlepassReward = BattlepassReward(
        ...
        fun itemReward(item: ItemStack, amount: Int, displayText: String): BattlepassReward = BattlepassReward(
        ...
        return if (track == RewardTrack.PLAYTIME) {
            when {
                ...
                7 -> itemReward(ItemManager.makeUpgradeSnowball(), 1, "&bx1 Upgrade Snowball")
                ...
                15 -> itemReward(ItemManager.makeUpgradeSnowball(), 2, "&bx2 Upgrade Snowballs")
                ...
                23 -> itemReward(ItemManager.makeUpgradeSnowball(), 3, "&bx3 Upgrade Snowballs")
                ...
                page == 1 -> when (pageTier) {
                    ...
                    8 -> itemReward(ItemManager.makeUpgradeSnowball(), 4, "&bx4 Upgrade Snowballs")
                    ...
                    24 -> itemReward(ItemManager.makeUpgradeSnowball(), 6, "&bx6 Upgrade Snowballs")
                    ...
                    15 -> itemReward(ItemManager.makeUpgradeSnowball(), 8, "&bx8 Upgrade Snowballs")
            ...
            when {
                ...
                6 -> itemReward(ItemManager.makeUpgradeSnowball(), 1, "&bx1 Upgrade Snowball")
                ...
                14 -> itemReward(ItemManager.makeUpgradeSnowball(), 2, "&bx2 Upgrade Snowballs")
                ...
                22 -> itemReward(ItemManager.makeUpgradeSnowball(), 3, "&bx3 Upgrade Snowballs")
                ...
                page == 1 -> when (pageTier) {
                    ...
                    6 -> itemReward(ItemManager.makeUpgradeSnowball(), 4, "&bx4 Upgrade Snowballs")
                    ...
                    15 -> itemReward(ItemManager.makeUpgradeSnowball(), 6, "&bx6 Upgrade Snowballs")
                    ...
                    4 -> itemReward(ItemManager.makeUpgradeSnowball(), 8, "&bx8 Upgrade Snowballs")
                    ...
                    27 -> itemReward(ItemManager.makeUpgradeSnowball(), 12, "&bx12 Upgrade Snowballs")
                    29 -> itemReward(ItemManager.makeUpgradeScroll(ScrollRarity.SECRET), 2, "&dx2 Secret Upgrade Scrolls")
